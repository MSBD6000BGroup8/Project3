...
def cnn_model_fn(features, labels, mode):
  ...
  conv1 = tf.layers.conv2d(inputs=input_layer, filters=96, kernel_size=[3, 3], strides=1, padding="same", activation=tf.nn.relu, kernel_initializer=None)
  ...
  conv2 = tf.layers.conv2d(inputs=pool1, filters=256, kernel_size=[3, 3], strides=1, padding="same", activation=tf.nn.relu, kernel_initializer=None)
